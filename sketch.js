...
var missile, missileImg, missileGrp, invisibleBlock, invisibleGroup;
...
function draw() {
  ...
  if (gameState === "Play") {
    ...
    if (invisibleGroup.isTouching(coinGrp)) {
      coinGrp.destroyEach();
    ...
    if (timeSurvived > 500 && timeSurvived < 1000) {
      ...
      invisibleGroup.setVelocityXEach(-10)
    ...
    if (timeSurvived > 1000) {
      ...
      invisibleGroup.setVelocityXEach(-13)
    ...
    if (boxGroup.isTouching(sonic) || invisibleGroup.isTouching(sonic)) {
      gameState = "End";
      overSound.play();
    }
...
function missssile() {
  ...
  if (frameCount % 200 === 0) {
    ...
    invisibleBlock.y = missile.y;
    invisibleBlock.x = missile.x;
    invisibleBlock.width = 40;
    invisibleBlock.height = 25;
    invisibleBlock.visible = false;
    invisibleBlock.velocityX = missile.velocityX;
